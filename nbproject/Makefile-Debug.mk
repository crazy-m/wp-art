...
${OBJECTDIR}/dlgAbout.o: dlgAbout.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/dlgAbout.o dlgAbout.c
...
${OBJECTDIR}/commport.o: commport.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/commport.o commport.c

${OBJECTDIR}/dlgSettings.o: dlgSettings.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/dlgSettings.o dlgSettings.c
